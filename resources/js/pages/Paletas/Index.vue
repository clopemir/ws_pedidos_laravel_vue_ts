...
const breadcrumbs: BreadcrumbItem[] = [{title: 'Paletas', href: '/productos'}];
            ...
            <Table>
                ...
                <TableBody>
                    <TableRow v-for="producto in productos" :key="producto.id">
                        ...
                        <TableCell class="text-center"><img class="inline-block size-8 rounded-full ring-2 ring-white" :src="`storage/${producto.imagen}`" :alt="`${producto.nombre}`"></TableCell>
